...
class $AssetsSvgGen {
  ...
  /// File path: assets/svg/agency.svg
  SvgGenImage get agency => const SvgGenImage('assets/svg/agency.svg');
  ...
  /// File path: assets/svg/news_placeholder.svg
  SvgGenImage get newsPlaceholder =>
      const SvgGenImage('assets/svg/news_placeholder.svg');
  ...
  List<SvgGenImage> get values =>
      [agency, home, homeFilled, logo, newsPlaceholder, search, settings];
}
